...
bool ImGui::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilled(ImGui::GetWindowPos() + ImVec2(0, border ? 20 : 5), ImGui::GetWindowPos() + size_arg, ImColor(15, 13, 17), 1);
  //  ImGui::SetCursorPos(ImVec2());
   // parent_window->DrawList->AddRectFilled(ImGui::GetWindowPos() + ImVec2(0, border ? 37 : 23), ImGui::GetWindowPos() + ImVec2(size_arg.x, border ? 40 : 25), ImColor(0, 183, 255), 0);
    parent_window->DrawList->AddRect(ImGui::GetWindowPos() + ImVec2(0, border ? 20 : 5), ImGui::GetWindowPos() + size_arg, ImColor(28 + test, 30 + test, 32 + test), 1);
    parent_window->DrawList->AddText(ImGui::GetWindowPos() + ImVec2(5, border ? 22 : 7), ImColor(200, 200, 200), name);
    InvisibleButton("SpacingYEAH", ImVec2(size_arg.x, 30));
    return ret;
}
