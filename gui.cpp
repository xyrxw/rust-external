...
void check()
{
    ...
    ImGui::SetCursorPos(ImVec2(380, 523));
    if (ImGui::Button(safe_str("Panic"))) { exit(1); };
           ...
           draw_list->AddRectFilled(ImVec2(pos.x, pos.y + 30), ImVec2(pos.x + 130, pos.y + 355), ImGui::GetColorU32(ImGuiCol_TabBar), 9, 4);
            ...
            case 1:
                ...
                ImGui::BeginChild("        ", ImVec2(440, 500)); // player esp
                {
                    ...
                    ImGui::ColorEdit4(safe_str("BOX"), vars.esp_color, ImGuiColorEditFlags_NoInputs);
                    ImGui::ColorEdit4(safe_str("skeleton"), vars.drawColor_skeleton, ImGuiColorEditFlags_NoInputs);
